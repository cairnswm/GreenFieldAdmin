            ...
            <Container style={{background:"white",borderBottom:"1px solid lightgrey",borderTop:"1px solid lightgrey",maxWidth:"100%"}} className="p-2">
              ...
              <Row className="p-3">
                <Col xs={12} md={6}>
                  ...
                  <h5>Heading 5</h5>
                  <Text>case="uppercase"</Text><Text case="uppercase">case="uppercase" Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis mollis, est non commodo luctus.</Text>
                  <h6>Heading 6</h6>
                  <Text as="span">size="3" as="span"</Text><Text as="span" fs={3} light bg="secondary">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis mollis, est non commodo luctus.</Text>
                </Col>
                <Col xs={12} md={6}>
