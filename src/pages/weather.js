...
const WeatherPage = (props) => {
	...
	const { location, setLocation, weather, loading: loadingWeather } = useContext(WeatherContext);
	...
	return (
		<div>
			<Container
				...
				className='p-2'>
				<div className='ms-3'>
					<h1 style={{ textAlign: "left", fontSize: "30px", color: "grey", marginBottom: "0px" }}>Weather</h1>
			...
			<Container className='p-3'>
				<Row>
					...
					<Col lg={12} xl={8}>
						<Card>
							<Card.Header>Today
								{location && weather.location ? (<span> in {location}, {weather.location.region}, {weather.location.country}</span>) : ""}
							</Card.Header>
							<Card.Body>
								{loadingWeather ? (
									<>
									...
									<div>
										<Row>
											...
											<Col md={6} lg={4}>
												Wind Direction: {weather.current.wind_degree} &deg; ({weather.current.wind_dir})<br/>
												Wind Speed: {weather.current.wind_kph} km/h<br/>
